...
- **ShuttleIQ Marketplace**: Player-facing booking and community platform with:
    ...
    - **Admin Marketplace**: Admin-only dashboard for managing bookable sessions, viewing bookings, marking attendance, and managing marketplace users. Bookable sessions can be linked to admin queue-management sessions via a dropdown in the Sessions tab (`PATCH /api/marketplace/sessions/:id/link`), enabling check-in-to-queue integration.
