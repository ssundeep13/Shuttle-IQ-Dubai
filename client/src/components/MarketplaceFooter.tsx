        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/marketplace/blog" className="hover:text-foreground transition-colors" data-testid="link-footer-blog">Blog</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/marketplace/scoring-guide" className="hover:text-foreground transition-colors" data-testid="link-footer-scoring-guide">Scoring Guide</Link></li>
